					...
					<div class="card-body text-center pb-3">
						...
						<div class="achievements ">
							...
							<div class="achievements-content flex-wrap">
								<span><img src="{{ asset('images/svg/cup.svg') }}"  alt=""></span>
								<span><img src="{{ asset('images/svg/puzzle.svg') }}" alt=""></span>
								<span><img src="{{ asset('images/svg/planet.svg') }}" alt=""></span>
								<span><img src="{{ asset('images/svg/skill.svg') }}" alt=""></span>
								<span><img src="{{ asset('images/svg/readingtime.svg') }}" alt=""></span>
							</div>	
						</div>
						...
						<div class="card profile-widget">
							<div class="card-body">
								<div class="widget-courses align-items-center d-flex justify-content-between style-1 flex-wrap">
									<div class="d-flex">
										<img src="{{ asset('images/svg/degree-certificate.svg') }}"  alt="">
										<div class="ms-4">
											<h4>100</h4>
											<span>Completed</span>
										</div>	
									</div>	
									<a href="{!! url('/courses'); !!}"><i class="las la-angle-right text-primary"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6 col-lg-6 col-sm-6">
						<div class="card profile-widget">
							<div class="card-body">
								<div class="widget-courses align-items-center d-flex justify-content-between style-1 flex-wrap">
									<div class="d-flex">
										<img src="{{ asset('images/svg/clock-1.svg') }}"  alt="">
										<div class="ms-4">
											<h4>100</h4>
											<span>Progress</span>
										</div>	
									</div>	
									<a href="{!! url('/courses'); !!}"><i class="las la-angle-right text-secondary"></i></a>
								</div>
							</div>
						</div>
					</div>
