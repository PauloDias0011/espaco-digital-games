...
@section('content')
	<div class="container-fluid">
		<div class="widget-heading d-flex justify-content-between align-items-center">
			...
			<a href="{!! url('/courses'); !!}" class="btn btn-primary btn-sm">View all</a>
		</div>
		<div class="row">
						...
						<div class="card-body">
							<div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
								<div class="d-flex align-items-center flex-wrap">
									<img src="{{ asset('images/svg/color-palette.svg') }}" alt="">
				...
				<div class="swiper-slide">
					<div class="card">
						<div class="card-body">
							<div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
								<div class="d-flex align-items-center flex-wrap">
									<img src="{{ asset('images/svg/education-website.svg') }}" alt="">
									<div class="flex-1 ms-3">
										<h4>Coading</h4>
										<span>Lorem ipsum dolor</span>
									</div>	
				...
				<div class="swiper-slide">
					<div class="card">
						<div class="card-body">
							<div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
								<div class="d-flex align-items-center flex-wrap">
									<img src="{{ asset('images/svg/brain.svg') }}" alt="">
									<div class="flex-1 ms-3">
										<h4>Soft Skill</h4>
										<span>Lorem ipsum dolor</span>
									</div>	
				...
				<div class="swiper-slide">
					<div class="card">
						<div class="card-body">
							<div class="widget-courses align-items-center d-flex justify-content-between flex-wrap">
								<div class="d-flex align-items-center flex-wrap">
									<img src="{{ asset('images/svg/microscope.svg') }}" alt="">
									<div class="flex-1 ms-3">
										<h4>Science</h4>
										<span>Lorem ipsum dolor</span>
									</div>	
					...
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course1.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-1'); !!}">Fullstack Developer</a></h4>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card all-crs-wid">
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course2.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-2'); !!}">UI Design Beginner</a></h4>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card all-crs-wid">
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course3.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-1'); !!}">How to be Freelancer</a></h4>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card all-crs-wid">
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course4.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-2'); !!}">UX Research</a></h4>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card all-crs-wid">
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course5.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-1'); !!}">Basic Web Design</a></h4>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card all-crs-wid">
					<div class="card-body">
						<div class="courses-bx">
							<div class="dlab-media">
								<img src="{{ asset('images/courses/course6.jpg') }}" alt="">
							</div>
							<div class="dlab-info">
								<div class="dlab-title d-flex justify-content-between">
									<div>
										<h4><a href="{!! url('/course-details-2'); !!}">3D Character Design</a></h4>
