...
<head>
    ...
    <meta property="og:title" content="GetSkills  : GetSkills Online Learning  Admin laravel Bootstrap 5 Template" />
    <meta property="og:description" content="Espaço Digital | @yield('title', $page_title ?? '')" />
    <meta property="og:image" content="https://getskills.dexignzone.com/laravel/social-image.png" />
    <meta name="format-detection" content="telephone=no">
    
    <!-- PAGE TITLE HERE -->
    <title>Espaço Digital | @yield('title', $page_title ?? '')</title>
    
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/avatar/favicon.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('images/avatar/favicon.png') }}" />
    ...
    {{-- Espaço Digital Custom Theme --}}
    <link href="{{ asset('css/espaco-digital-theme.css') }}" rel="stylesheet" type="text/css"/>  
</head>
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ request()->is('superadmin*') ? route('superadmin.dashboard') : url('/index') }}" class="brand-logo">
                <img src="{{ asset('images/avatar/favicon.png') }}" alt="Espaço Digital" class="logo-abbr">
                <img src="{{ asset('images/logomarca.png') }}" alt="Espaço Digital" class="brand-title">
            </a>
        ...
        ***********************************-->
        @if(request()->is('superadmin*'))
            @include('elements.sidebar-superadmin')
        @else
