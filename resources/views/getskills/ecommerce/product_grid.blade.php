                    ...
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">Bonorum et Malorum</a></h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">Striped Dress</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">BBow polka-dot</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">Z Product 360</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">Chair Grey</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">fox sake withe</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">Back Bag</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="new-arrival-product">
                            ...
                            <div class="new-arrival-content text-center mt-3">
                                <h4 class="mb-1"><a href="{!! url('/ecom-product-detail'); !!}">FLARE DRESS</a></h4>
                                <ul class="star-rating mb-2">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
