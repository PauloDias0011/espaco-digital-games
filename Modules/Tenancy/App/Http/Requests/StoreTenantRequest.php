        ...
        return [
            'name' => [
                ...
                function ($attribute, $value, $fail) {
                    $exists = \Modules\Tenancy\App\Models\Tenant::all()->contains(function ($tenant) use ($value) {
                        return strtolower($tenant->getName()) === strtolower($value);
                    });
            ...
            'slug' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    $exists = \Modules\Tenancy\App\Models\Tenant::all()->contains(function ($tenant) use ($value) {
                        return strtolower($tenant->getSlug()) === strtolower($value);
                    });
