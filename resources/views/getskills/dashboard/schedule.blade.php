				...
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="widget-heading d-flex justify-content-between align-items-center">
							...
							<a href="{!! url('/instructor-schedule'); !!}" class="btn btn-primary btn-sm">View all</a>
						</div>
							...
							<div class="up-comming-schedule">
								...
								<div>
									...
									<div class="mb-sm-0 mb-2">
										<img src="{{ asset('images/profile/small/pic8.jpg') }}" class="me-2" alt="">
								...
								<div>
									<a href="{!! url('/instructor-schedule'); !!}"><i class="las la-angle-right text-secondary"></i></a>
								</div>
							</div>
						</div>
						<div class="card-schedule">
							...
							<div class="up-comming-schedule">
								...
								<div>
									...
									<div class="mb-sm-0 mb-2">
										<img src="{{ asset('images/profile/small/pic7.jpg') }}" class="me-2" alt="">
										<span>Ms. Samantha William</span>
									</div>
								</div>
								<div>
						...
						<div class="card-schedule">
							...
							<div class="up-comming-schedule">
								...
								<div>
									...
									<div class="mb-sm-0 mb-2">
										<img src="{{ asset('images/profile/small/pic6.jpg') }}" class="me-2" alt="">
										<span>Ms. Samantha William</span>
									</div>
								</div>
								<div>
