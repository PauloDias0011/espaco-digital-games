				...
				<div class="row">
							...
							<div class="card-body pt-0">
								<div class="card-schedule">
									...
									<div class="up-comming-schedule style-1">
										...
										<div class="flex-1">
											<h4 class="mb-0"><a href="javascript:void(0);">UX Research</a></h4>
								...
								<div class="card-schedule">
									<span class="side-label bg-info"></span>
									<div class="up-comming-schedule style-1">
										<div class="date-box">
											<span>5 </span>
											<span>jan</span>
								...
								<div class="card-schedule">
									<span class="side-label bg-success"></span>
									<div class="up-comming-schedule style-1">
										<div class="date-box">
											<span>5 </span>
											<span>jan</span>
					...
					<div class="col-xl-12 col-sm-6">
						<div class="card">
							...
							<div class="card-body pt-0">
								<div class="upcomming-task-widget d-flex justify-content-between">
									<div class="d-flex">
									...
									<div class="">
										<span class="fs-12">17/07/2022</span>
										<span class="font-w600 text-end text-primary">2 Days</span>
