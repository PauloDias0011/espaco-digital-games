				...
				<div class="card">
					<div class="card-body">
						...
						<div class="video-img style-1">
							<div class="view-demo">
								<img src="{{ asset('images/courses/video-img.jpg') }}" alt="">
				...
				<div class="card h-auto">
					...
					<div class="card-body pt-0">
						<div class="progress-box">
							<div class="progress ">
								<div class="progress-bar bg-primary" style="width:15%; height:12px; border-radius:4px;" role="progressbar"></div>
							</div>
							
							<div class="d-flex align-items-center justify-content-between">
								<h5 class="mb-0 fs-14 font-w600">Full-Stack Web Developer</h5>
